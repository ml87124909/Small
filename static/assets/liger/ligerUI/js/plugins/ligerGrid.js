    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {	
            ...
            if (p.height == "auto")
            {
                ...
                {
                    if (g.enabledFrozen())
                        g.gridview.height(Math.max(p.height, g.gridview2.height()));
                });
			}
            var pc = $.extend({}, p);
        ...
        {	
            ...
            else if (typeof (loadDataParm) == "object" && loadDataParm)
            {
                ...
                p.dataType = "local";
                p.data = loadDataParm;
				if (p.usePager == true) //增加此处默认页码；防止数据页码错乱
				{	p.newPage = p.page;
				}
        ...
        */
		...
		getAsData:function(){ //新增获取所有排序后数据 MINZ - 2017-06-21
			var g = this, p = this.options;
			if(!g.sortedData){
				return p.data
			}
        ...
        getColumnByName: function (columnname)  //通过名称获取列
        {
            var g = this, p = this.options;
        ...
        getColumnType: function (columnname)  //获取列类型
        {
            var g = this, p = this.options;
            for (i = 0; i < g.columns.length; i++)
            {
        ...
        _initFootbar: function ()
        {
            ...
            if (p.usePager)
            {
                ...
                $('.l-bar-selectpagesize', g.toolbar).append("<select name='rp' style='width:40px;'>" + optStr + "</select>");
        ...
        _onResize: function ()
        {
            ...
            if (g.enabledFrozen())
            {
                ...
                if (gridViewWidth - gridView1Width <= 0 && p.width !='auto' )
                {
                    g.gridview2.css({
                        width: p.width
                    });
