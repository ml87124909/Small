...
(function ($)
{
    ...
    $.ligerui.controls.Filter.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _bulidGroupTableHtml: function (altering, allowDelete)
        {
            ...
            //and or
            tableHtmlArr.push('<select class="groupopsel" style="width:50px;">');
        ...
        _bulidRuleRowHtml: function (fields)
        {
            ...
            rowHtmlArr.push('<select class="fieldsel" style="width:100px">');
            ...
            rowHtmlArr.push('<select class="opsel" style="width:60px;">'); 
            ...
            rowHtmlArr.push('<input type="text" class="valtxt" style="width:150px;" />');
            rowHtmlArr.push('</td>');
            rowHtmlArr.push('<td>');
