...
class cJ001_dl(cBASE_DL):
    ...
    def local_add_save(self):
        ...
        if pk != '':  #update
            ...
            sql="""insert into users(login_id, password, usr_name, status, usr_type, dept_id, del_flag, ismanage, is_dept_manage, sort,cid,ctime,mobile,usr_id_p)
