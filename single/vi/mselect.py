            ...
            s = """<script>
                    ...
                    function %(name)s_loadUsers_success(data){
                        ...
                        for(i=0;i<listLen;i++){
                            ...
                            tr += '<td >'+'<a  href="single?fid=F012&pageNo=1&part=localfrm&pk='+data.list[i][dnl[0]]+'" target="_blank">查看</a>'+'</td>';
                            tr += '</tr>';
                            tr_total += tr;
                        }
                        tbody.html(tr_total);
            ...
            s = """<script>
                    ...
                    function %(name)s_loadUsers_success(data){
                        ...
                        for(i=0;i<listLen;i++){
                            ...
                            if(data.list[i][4]!=6){
                                tr += '<td >'+'<a  href="single?fid=F008&pageNo=1&part=localfrm&pk='+data.list[i][0]+'" target="_blank">查看</a>'+'</td>';
                            }else{
                                tr += '<td >'+'<a  href="single?fid=F104&pageNo=1&part=localfrm&pk='+data.list[i][0]+'" target="_blank">查看</a>'+'</td>';
                            }
        ...
        s = """<script>
                ...
                function %(name)s_loadUsers_success(data){
                    ...
                    for(i=0;i<listLen;i++){
                        ...
                        tr += '<td style=width:10%%>'+'<a  href="single?fid=F104&pageNo=1&part=localfrm&pk='+data.list[i][dnl[0]]+'" target="_blank">查看</a>'+'</td>';
                        tr += '</tr>';
                        tr_total += tr;
                    }
                    tbody.html(tr_total);
        ...
        s = """<script>
                ...
                function %(name)s_loadUsers_success(data){
                    ...
                    for(i=0;i<listLen;i++){
                        ...
                        tr += '<td style=width:10%%>'+'<a  href="single?fid=SH204&pageNo=1&part=localfrm&pk='+data.list[i][dnl[0]]+'" target="_blank">查看</a>'+'</td>';
                        tr += '</tr>';
                        tr_total += tr;
                    }
                    tbody.html(tr_total);
        ...
        s = """
            ...
            <script type="text/javascript">
             ...
             function streemenu() {  
                    ...
                    urls = "single?viewid=%(viewid)s&part=ajax&action=getTree&tree_pk="+tree_pk;
                    $.ajax({
                        type: "get",
                        async:false,
                        url: urls,
        ...
        s = """
            ...
            <script type="text/javascript">
             ...
             function streemenu() {  
                    ...
                    urls = "single?viewid=%(viewid)s&part=ajax&action=getSpec_c&tree_pk="+tree_pk;
                    $.ajax({
                        type: "get",
                        async:false,
                        url: urls,
