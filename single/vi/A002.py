...
from single.vi.mselect  import mselect_forJF_type,mselect_forHT,mselect_forYK
...
class cA002(cBASE_TPL):
    ...
    def JF_mselect(self):
        ...
        mSelect.sUrl = 'single?viewid=A002&part=ajax&action=jftype'
    ...
    #         save_alert = 2
    #
    #     url = "single?viewid=%s&part=localfrm&save_alert=%s" % (self.viewid,save_alert)
    #     if pk!='':
    #         url = "single?viewid=%s&part=localfrm&pk=%s&save_alert=%s" % (self.viewid, pk,save_alert)
    #
